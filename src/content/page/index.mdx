---
title: Västljus
description: Västljus - Sveriges ljusaste tillvaro
intro: En kortare förklaring om vilka ni är
hero_template: image
template: full
container: md
hero_buttons:
...
blocks:
  ...
  - type: recentitems
    ...
    template: grid
    animate: false
    title: Missa inte våra kommande evenemang
...
style:
  ...
  hero_image_opacity: ""
thumbnail: /src/assets/västljus.jpg
og_image: /src/assets/og_image_nebulix.png
media_folder: src/assets
public_folder: /src/assets
---
## Välkommen till Västljus
