...
tag:
  - Features
title: Föreläsning om Ljusamallen
description: Vi välkomnar er till en lunchträff den 28 mars kl. 11.30 – 13.30.
  Gästföreläsare Johan Elm från Belysningsbranschen kommer berätta om
  uppdateringen och arbetet bakom nya versionen av Ljusamallen.
intro: "Tid: torsdag den 28 mars kl 11.30 – 13.30"
hero_buttons:
  - icon_only: false
    label: snipcart
...
thumbnail: /src/assets/väsljus3.jpg
